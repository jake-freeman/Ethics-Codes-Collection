...
ActiveRecord::Schema.define(version: 20161108200621) do
  ...
  create_table "code_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string  "title"
    t.text    "code_body",              limit: 65535
    t.text    "description",            limit: 65535
    t.date    "year_pub"
    t.integer "tag_id"
    t.integer "organizations_table_id"
    t.integer "object_table_id"
    t.index ["object_table_id"], name: "object_table_id", using: :btree
    t.index ["organizations_table_id"], name: "fk_rails_0e183145d5", using: :btree
  end
  ...
  create_table "ob_to_tag_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "tags_table_id"
    t.integer "object_table_id"
    t.index ["object_table_id"], name: "object_table_id", using: :btree
    t.index ["tags_table_id"], name: "fk_rails_91bd0a1e65", using: :btree
  end

  create_table "object_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "object_id"
  end

  create_table "organizations_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string  "name"
  ...
  create_table "tags_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string  "name"
    t.integer "tag_id"
    t.integer "tags_tables_id"
  end
  ...
  add_foreign_key "code_tables", "object_tables", name: "code_tables_ibfk_1"
  add_foreign_key "code_tables", "organizations_tables"
